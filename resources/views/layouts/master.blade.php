...
<!-- Mirrored from rockstheme.com/rocks/liti-preview/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 06:49:53 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Home 02 - Liti</title>
...
<body>
                                ...
                                <div class="header_menu f-right">
                                    <nav id="mobile-menu">
                                        <ul class="main-menu">
                                            ...
                                            <li><a href="{{ route('animation.index') }}">Animation</a></li>
                                            <li class="menu-item-has-children"><a href="#">Pages</a>
                                                <ul class="submenu">
                                                    <li><a href="about.html">About</a></li>
                                                    <li><a href="service.html">Services</a></li>
                                                    <li><a href="anime-details.html">Aname Ditails</a></li>
                                            ...
                                            <li class="contact"><a href="{{ route('contact.index') }}">Contacts</a>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
    ...
    <footer class="footer1">
        <div class="footer-area">
            ...
            <div class="footer-top-image wow fadeInLeft" data-wow-delay="0.2s">
                <img src="img/background/foot1.png" alt="">
            </div>
            <div class="footer-top-image-2 wow fadeInRight" data-wow-delay="0.2s">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="copyright">
                            <p>
                                Copyright © 2023
                                <a href="{{ route('welcome') }}">Liti</a> All Rights Reserved
                            </p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from rockstheme.com/rocks/liti-preview/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 06:49:55 GMT -->
</html>
